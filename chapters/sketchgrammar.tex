\addchap{Foreword and Grammar Sketch}
\begin{refsection}

 %to Ali and Grimm: Dagaare – English Dictionary
...
representation. This is shown in Table \ref{tab:Consonants}.
\begin{table}[]
    \centering
...
\ Stops  \\
\ \hspace{.5em} voiceless &p & & t &&&& k & kp & \textglotstop \\
\ \hspace{.5em}voiced &b & &d&&&& g &gb& \\
\ Affricates \\
\ \hspace{.5em}voiceless &&&&& ky &&&& \\
\ \hspace{.5em}voiced &&&&&gy&&&&\\
\ Fricatives \\
\ \hspace{.5em}voiceless &&f&& s&&&& h \\
\ \hspace{.5em}voiced &&v&& z  \\
\ Lateral &&&&l  \\
\ \hspace{.5em}nasal &m&&& n && \textltailn && \ng m & \ng \\
\ Implosive & \texthmlig &&&‘l &&&&& \texthth  \\
\ Glide &&&&&&y&& w      \\\lspbottomrule
\end{tabular}}    \caption{Consonants}
...
In these examples /d/ and /g/ are at primary word/syllable initial position. The sounds, [r] and [ɣ], on the other hand, occur intervocalically or at secondary syllable initial position. Voiceless plosives are usually aspirated when they occur in primary syllable initial position. The phonetic transcriptions: [t\textsuperscript{h}àllɪ̀] ‘to walk fast’ and [p\textsuperscript{h}àllɪ̀] ‘to weave’ illustrate aspiration.
...
\ea  \ea{\label{ex:elision1} \begin{tabular}{llll} 
...
/pɔ́g-bɔ́/&  $\sim$ &*/pɔ́gb/ &‘women’\\\end{tabular}}\z\z 
...
system of labeled noun classes in the Mabia languages. In \citet{Bodomo1997}, an attempt is made to group Dàgáárè nouns into a labeled system of noun classes.  Table \ref{tab:classstems} is
...
woman certain PAST come FOC here\\
...
DEF child that PAST come FOC here\\
...
in the language. Table \ref{tab:numerals} shows a list of cardinal numbers from 1 to 10.
\begin{table}[]
    \centering
    \begin{tabular}{llll}\lsptoprule
...
\ea \ea[] {\label{ex:ordnumerals}\begin{tabular}{ll}\ bóyì& ‘two times’\\
\ bótà &‘three times’\\
\ gbɛ́ɛ̀ píé& ‘ten times’\\
\ gbɛ́ɛ̀ lèzárè &‘twenty times'\\
\end{tabular}}
\ex[]{\label{ex:ordnumerals2}\begin{tabular}{ll}\ dɔ́bɔ́ bànúú& ‘five men’\\
\ bóóré ànúú& ‘five goats’\\
\ bátà sòbɔ́& ‘the third person’\\
\ átà sòbɔ́& ‘the third (thing)’ \\\end{tabular}}\z\z
...
3.SG PAST go.home-PERFINTR FOC\\
\glt‘S/he went home.’}
\ex[] {\gll ò dà kúl-ó lá\\
3.SG PAST go.home-IMP FOC\\
...
\ea \ea[] {\begin{tabular}{ll}\  zo-  &verb root\\
\  à zò  &dictionary form\\
\  zò-Ø  & PERF\\
\  zò-e  & PERFINT\\
\  zò-ró  & IMP\\
\  zò-é-ńg  &FOC particle on PERF\\
\end{tabular}} 
\ex[] {\begin{tabular}{ll}\ vɔg-   &verb root\\
\  à vɔ̀gè  &dictionary form\\
\  vɔ̀gè-Ø & PERF\\
\  vɔ̀g-ɛ̀ɛ́  & PERFINT\\
\  vɔ̀g-ɛ̀ɛ̀-ńg  &FOC particle on PERF\\
\end{tabular}}\z\z
...
processes such as causativity, transitivity, reversivity and many others. Table \ref{tab:verbOppositions} is an
...
developed as the derivational systems of Bantu. From Table \ref{tab:verbOppositions}, there is only one
...
\ea\label{ex:ideophonesexx} \ea[]{\gll  à lánggbáráà lá ká ó dé lɔ́ɔ́, gbàngbàràng\\
DEF hook TOP COMP 3.SG take throw-down, IDEOPH.\\
\glt ‘It is the hook s/he has thrown down.’}
\ex[]{\gll bíní lá ká ó nyɛ̀ bìng, vàrkpàrà\\
excreta TOP COMP 3.SG shit put down, IDEOPH\\
\glt ‘It is excreta s/he has shit.’}
\ex[]{\gll à bíé bàlɛ̀ɛ̀ lá , à páà lè gàngè, gàrmànà\\
DEF child tire-PERF FOC DEF then fall lie down, IDEOPH\\
\glt ‘The child is tired and then is lying there.’}
\ex[]{\gll nyɛ́ ò nàng páà zèng bɔ̀nggɔ̀lɔ̀ng lɛ́\\
see 3.SG when then sit IDEOPH PART\\
\glt ‘Just see how s/he is seated!’}
\ex[]{\gll ò dé lá à dàngmáá lɔ́ɔ́, bìlbàlà\\
3.SG take FOC DEF log throw.down IDEOPH\\
\glt ‘He threw down the log.’}\z\z
...
\ea \label{ex:compounding} \ea[]{\label{ex:compoundingA}\begin{tabular}{p{1.5cm}p{1.1cm}p{1.2cm}p{.5cm}p{3.5cm}} 
 dɔ́ɔ́ + &-léé& &$\rightarrow$& dɔ̀ɔ̀léé\\
 man & small&&& ‘boy’ \\\end{tabular}}
\ex[]{\label{ex:compoundingB}\begin{tabular}{p{1.5cm}p{1.1cm}p{1.2cm}p{.5cm}p{3.5cm}} 
 néɛ̀ + &fáá &&$\rightarrow$& néngfáá\\
 person & bad&&& ‘bad fellow’ \\\end{tabular}}
\ex[]{\label{ex:compoundingC}\begin{tabular}{p{1.5cm}p{1.1cm}p{1.2cm}p{.5cm}p{3.5cm}} 
 dìé + &pɔ́gɔ́ &&$\rightarrow$& dìépɔ́gɔ́\\
 room & woman&&& ‘wife, housewife, homemaker’\\ \end{tabular}}
\ex[]{\label{ex:compoundingD}\begin{tabular}{p{1.5cm}p{1.1cm}p{1.2cm}p{.5cm}p{3.5cm}} 
 yɔ́ + &tá &&$\rightarrow$ &yɔ́tá\\
 roam & reach&&& personal name (one who gets to destination)  \end{tabular}}
\ex[]{\label{ex:compoundingE}\begin{tabular}{p{1.5cm}p{1.1cm}p{1.2cm}p{.5cm}p{3.5cm}} 
 bɔ̀ng + &gánè &&$\rightarrow$ &gánbɔ́gnɔ́\\
 know & book&&& ‘literate’ \end{tabular}}
\ex[]{\label{ex:compoundingF}\begin{tabular}{p{1.5cm}p{1.1cm}p{1.2cm}p{.5cm}p{3.5cm}} 
...
Dakoraa PAST drink-IMP FOC DEF water DEF room POSTP\\
...
Dakoraa PAST NEG drink DEF water\\
...
3.SG PAST run pass 3.SG.OBJ FOC\\
...
Naana PAST get.out FOC school go.home CONJ go sit eat-IMP thing-PL\\
...
to be discussed (e.g. \citet{Bodomo1993, Bodomo1997, Bodomo1997Pathfinders}). Some of these are whether the serial verb
...
3.SG PAST take FOC DEF water drink\\
...
Dakoraa PAST NEG eat DEF saao morning period\\
...
Dakoraa PAST NEG eat FOC DEF saao morning period\\
\glt ‘Dakoraa did not eat the saao this morning.’}
\ex{\label{ex:focusnegC} \gll Dàkóráá náá dà dì à sááó bágúó sángà\\
Dakoraa FOC.NEG PAST eat DEF saao morning period\\
...
DEF saao FOC.NEG COMP Dakoraa PAST eat morning DEM\\
...
morning period FOC.NEG COMP Dakoraa PAST eat DEF saao\\
...
Eat-NOM FOC.NEG COMP Dakoraa PAST eat DEF saao morning period\\
